...
function ConfigGtfs() {
    var configList = [
        ...
        {'name': 'Oulu', 'file': 'oulu', 'dir': 'oulu',
         ...
         'vehicle_types': ['bus'],
         'visible_types': ['bus']},
        {'name': 'Pori', 'file': 'pori', 'dir': 'pori',
         'lat': 61.524817, 'lng': 21.717732, 'zl': 11, 'alerts': false, 'vp': false,
         'vehicle_types': ['bus'],
         'visible_types': ['bus']},
        {'name': 'Rovaniemi', 'file': 'rovaniemi', 'dir': 'rovaniemi',
